...
XPlug::DynamicFeatureComponent::DynamicFeatureComponent(std::vector<Feature> features) :supportedFeatures(std::move(features)){}
...
XPlug::AutomaticFeatureComponent::AutomaticFeatureComponent():DynamicFeatureComponent::DynamicFeatureComponent()
{
}

XPlug::AutomaticFeatureComponent::AutomaticFeatureComponent(IPortComponent* pComp, std::vector<Feature> features) : DynamicFeatureComponent::DynamicFeatureComponent(features)
{
