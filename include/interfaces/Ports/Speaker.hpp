...
// constexpr std::underlying_type<SpeakerConfiguration>::type operator
// &(SpeakerPosition lhs) { return
// static_cast<std::underlying_type<SpeakerPosition>::type> (lhs); }
constexpr std::underlying_type<SpeakerConfiguration>::type
operator|(std::underlying_type<SpeakerConfiguration>::type lhs,
          SpeakerPosition rhs)
{
  return static_cast<std::underlying_type<SpeakerConfiguration>::type>(
    static_cast<std::underlying_type<SpeakerConfiguration>::type>(lhs) |
    static_cast<std::underlying_type<SpeakerPosition>::type>(rhs));
}
constexpr std::underlying_type<SpeakerConfiguration>::type
operator|(SpeakerConfiguration lhs, SpeakerPosition rhs)
{
  return static_cast<std::underlying_type<SpeakerConfiguration>::type>(
    static_cast<std::underlying_type<SpeakerConfiguration>::type>(lhs) |
    static_cast<std::underlying_type<SpeakerPosition>::type>(rhs));
...
constexpr std::underlying_type<SpeakerConfiguration>::type
operator|(SpeakerPosition lhs, SpeakerPosition rhs)
{
  return static_cast<std::underlying_type<SpeakerConfiguration>::type>(
    static_cast<std::underlying_type<SpeakerPosition>::type>(lhs) |
    static_cast<std::underlying_type<SpeakerPosition>::type>(rhs));
...
enum class SpeakerConfiguration : uint64_t
{
  ...
  MonoLegacy = SPOS_TO_SCONF(
    SpeakerPosition::FrontLeft), // Mono implementations for old speakers.
  ...
  Surround5_0Front = Stereo2_0 | SpeakerPosition::FrontCenter |
                     SpeakerPosition::RearLeft | SpeakerPosition::RearRight,
  Surround5_1Front = Surround5_0Front | SpeakerPosition::LowFrequency,
  Surround5_0Side = Stereo2_0 | SpeakerPosition::FrontCenter |
                    SpeakerPosition::SideLeft | SpeakerPosition::SideRight,
  Surround5_1Side = Surround5_0Side | SpeakerPosition::LowFrequency,
  Atmos5_1_4 = Stereo2_0 | SpeakerPosition::FrontCenter |
               SpeakerPosition::FrontLeftHeight |
               SpeakerPosition::FrontRightHeight |
               SpeakerPosition::LowFrequency,
  Surround6_0Back = Stereo2_0 | SpeakerPosition::FrontCenter |
                    SpeakerPosition::RearLeft | SpeakerPosition::RearRight |
                    SpeakerPosition::RearCenter,
  Surround6_1Back = Surround6_0Back | SpeakerPosition::LowFrequency,
  Surround6_0Front =
    Stereo2_0 | SpeakerPosition::FrontCenter | SpeakerPosition::RearLeft |
  ...
  Surround6_0Side = Stereo2_0 | SpeakerPosition::FrontCenter |
                    SpeakerPosition::RearLeft | SpeakerPosition::SideLeft |
                    SpeakerPosition::SideRight,
  Surround6_1Side = Surround6_0Side | SpeakerPosition::LowFrequency,
  Wide7_1 = Stereo2_0 | SpeakerPosition::FrontCenter |
            SpeakerPosition::FrontLeftOfCenter |
            SpeakerPosition::FrontRightOfCenter | SpeakerPosition::RearLeft |
            SpeakerPosition::RearRight | SpeakerPosition::LowFrequency,
...
/**
 * @brief  Gets the SpeakerPosition from given index. Stereo for example will
 * return with index 0 SpeakerPosition::Left and with index 1
 * SpeakerPosition::Right. The Templateparameter is the SpeakerConfiguration to
 * analyze
 * @param index Index of the SpeakerPosition to get.
 * @return single Bitmask with only 1 bit set. This can be represented as
 * SpeakerPosition.
 */
template<SpeakerConfiguration c>
constexpr SpeakerPosition
getSpeakerPositionAt(size_t index)
{
  size_t indexCounter = 0;
  for (size_t i = 0; i < sizeof(c); i++) {
    if (static_cast<uint64_t>(c) &
        ((uint64_t)1 << i)) { // check if bit is set in pos
