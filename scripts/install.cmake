...
if(NOT SKIP_TORTURE)
    ...
    execute_process(COMMAND cmake -DCMAKE_BUILD_TYPE=${BUILD_CONFIG}  -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX}/plugin-torture .. WORKING_DIRECTORY ${BUILD_DIR}/plugin-torture/build )
