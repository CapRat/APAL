...
if(WIN32)
    ...
    SET(VST3_INSTALL_PREFIX ${INSTALL_PREFIX}/plugin-tortue)
...
if(NOT SKIP_TORTURE)
    ...
    execute_process(COMMAND cmake -DCMAKE_BUILD_TYPE=${BUILD_CONFIG}  -DCMAKE_INSTALL_PREFIX=${TORTUE_INSTALL_PREFIX} .. WORKING_DIRECTORY ${BUILD_DIR}/plugin-torture/build )
