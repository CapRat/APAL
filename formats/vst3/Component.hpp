...
public:
	...
	virtual int32 PLUGIN_API getBusCount(MediaType type, BusDirection dir) override;
	/** Called after the Plug-in is initialized. See \ref MediaTypes, BusDirections */
	virtual tresult PLUGIN_API getBusInfo(MediaType type, BusDirection dir, int32 index, BusInfo& bus) override;
	...
	virtual tresult PLUGIN_API getRoutingInfo(RoutingInfo& inInfo, RoutingInfo& outInfo) override;
	...
	virtual tresult PLUGIN_API activateBus(MediaType type, BusDirection dir, int32 index, TBool state) override;
