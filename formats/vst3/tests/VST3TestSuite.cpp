...
public:
    ...
    /* virtual SucceedState processTestProcessing() {
         ...
         ProcessDataClass pData(inputs, outputs,SymbolicSampleSizes::kSample32,512);
         this->audioProcessor->process(pData);
         return res;
     }*/
#define TESTFAIL_IF(cond)   if (cond) {GlobalLog().logN(module.getLastError(), LoggerValue::ERROR);return TEST_FAILED;}
