...
public:
  ...
  virtual tresult PLUGIN_API getParamStringByValue(ParamID id,
  ...
  normalizedParamToPlain(ParamID id, ParamValue valueNormalized) override;
  virtual ParamValue PLUGIN_API
  plainParamToNormalized(ParamID id, ParamValue plainValue) override;
  virtual ParamValue PLUGIN_API getParamNormalized(ParamID id) override;
  virtual tresult PLUGIN_API setParamNormalized(ParamID id,
                                                ParamValue value) override;
  virtual tresult PLUGIN_API
  setComponentHandler(IComponentHandler* handler) override;
